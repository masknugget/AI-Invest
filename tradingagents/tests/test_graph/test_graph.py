...
config = {'backend_url': 'https://dashscope.aliyuncs.com/compatible-mode/v1',
          ...
          'deep_think_llm': 'qwen-max', 'llm_provider': 'dashscope', 'max_debate_rounds': 1, 'max_recur_limit': 100,
          'max_risk_discuss_rounds': 2, 'memory_enabled': True, 'online_news': True, 'online_tools': True,
