...
from app.services.analysis.simple_analysis_service import create_analysis_config, get_provider_by_model_name
...
from app.services.queue.redis_progress_tracker import RedisProgressTracker
...
from app.services.analysis.usage_statistics_service import UsageStatisticsService
...
class AnalysisService:
    ...
    def _execute_analysis_sync_with_progress(self, task: AnalysisTask, progress_tracker: RedisProgressTracker) -> AnalysisResult:
        ...
        try:
            ...
            # 使用标准配置函数创建完整配置
            from app.services.analysis.simple_analysis_service import create_analysis_config
    ...
    async def _execute_single_analysis_async(self, task: AnalysisTask):
        ...
        try:
            ...
            try:
                ...
                # 根据模型名称确定供应商
                from app.services.analysis.simple_analysis_service import get_provider_by_model_name
