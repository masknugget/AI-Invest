...
from app.services.queue.queue_service import get_queue_service, QueueService
...
async def get_task_result(
    ...
    try:
        ...
        if 'reports' not in result_data or not result_data['reports']:
            ...
            try:
                ...
                if stock_symbol and analysis_date:
                    ...
                    candidate_dirs.append(
                        project_root / 'data' / 'analysis_results' / 'detailed' / stock_symbol / analysis_date / 'reports')
        ...
        try:
            if not result_data.get('summary') or not result_data.get('recommendation') or not result_data.get(
                    'reports'):
